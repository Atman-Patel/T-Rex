...
function draw() {
  ...
  if(gameState === PLAY){
    // makeing the game over and restart sprites invisible
    gameOver.visible = false;
    restart.visible = false;
    
    // giving valocity to ground
    ground.velocityX = -(4 + 3* score/100)
    
    //scoring
    score = score + Math.round(getFrameRate()/60);
    
    // adding the check point sound
    ...
    if(obstaclesGroup.isTouching(trex)){
     ...
     // showing game over and restart sprites
